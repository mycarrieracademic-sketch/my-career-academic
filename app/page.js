...
const MCA_LOGO = "data:image/png;base64,";
...
function StudentDetailTab({ student, onBack }) {
  ...
  useEffect(() => {
    if (newCourseId) {
      supabase.from("subjects").select("*").eq("course_id", newCourseId).then(({ data }) => setAllSubjects(data || []));
    }
  }, [newCourseId]);
  ...
  const changeCourse = async () => {
    ...
    setNewCourseId("");
    setAdminMsg({ type: "success", text: `Course change ho gaya → ${nc?.name}` });
    setSaving(false);
    await loadAll();
  };
      ...
      <div className="card" style={{ marginBottom: 16, borderLeft: "4px solid var(--warning)" }}>
        ...
        {showCourseChange && (
          <div style={{ marginTop: 16, padding: 16, background: "var(--bg)", borderRadius: 8 }}>
            ...
            <label className="label">New course select karo</label>
            ...
            {allSubjects.length > 0 && (
              <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 12 }}>
                New subjects: {allSubjects.map(s => s.name).join(", ")}
              </div>
            )}
        ...
        {showFeeEdit && (
          <div style={{ marginTop: 16, padding: 16, background: "var(--bg)", borderRadius: 8 }}>
            ...
            <label className="label">Naya fee amount</label>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {currentStatus !== "dropped" && (
                <div style={{ padding: 12, background: "#fff", borderRadius: 8, border: "1px solid var(--border)" }}>
                  ...
                  <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 8 }}>Student beech mein chhod gaya ya nikaala gaya</div>
                  <button className="btn btn-danger" style={{ fontSize: 13 }} onClick={() => changeStatus("dropped")} disabled={saving}>Terminate / Drop karo</button>
                </div>
              )}
              {currentStatus !== "completed" && (
                <div style={{ padding: 12, background: "#fff", borderRadius: 8, border: "1px solid var(--border)" }}>
                  <div style={{ fontWeight: 600, fontSize: 13, marginBottom: 4 }}>✅ Course Complete — Account Close</div>
                  <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 8 }}>2 saal padhai khatam, record save karke account close karo</div>
              ...
              {currentStatus !== "active" && (
                <div style={{ padding: 12, background: "#fff", borderRadius: 8, border: "1px solid var(--border)" }}>
                  ...
                  <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 8 }}>Galti se band hua? Wapas active karo</div>
                  <button className="btn btn-success" style={{ fontSize: 13 }} onClick={() => changeStatus("active")} disabled={saving}>Wapas Active karo</button>
                </div>
              )}
...
function AdmissionTab() {
  ...
  const submit = async () => {
    if (!form.fullName || !form.phone || !form.courseId) {
      setMsg({ type: "error", text: "Name, phone aur class/stream required!" }); return;
    }
    if (!form.fee || Number(form.fee) <= 0) {
      setMsg({ type: "error", text: "Fee amount enter karo!" }); return;
    }
    ...
    try {
      ...
      setAdmittedData({
        ...
        selectedSubjectNames: subjects.filter(s => form.selectedSubjects.includes(s.id)).map(s => s.name)
      });
      setMsg({ type: "success", text: `✅ Admission ho gaya!\nAdmission No: ${admNo}\nPassword: ${tempPass}` });
  ...
  const printAdmission = () => {
    ...
    <tr><td><b>Subjects</b></td><td colspan="2">${d.selectedSubjectNames?.join(", ") || "-"}</td></tr>
        ...
        {step === 1 && (
          <div>
            ...
            <button className="btn" style={{ marginTop: 8 }} onClick={() => {
              if (!form.fullName || !form.phone) { setMsg({ type: "error", text: "Name aur phone required!" }); return; }
        ...
        {step === 2 && (
          <div>
            ...
            <div style={{ marginBottom: 20 }}>
              <label className="label" style={{ marginBottom: 10, display: "block" }}>Stream select karo *</label>
            ...
            {selStream && (
              <div style={{ marginBottom: 20 }}>
                <label className="label" style={{ marginBottom: 10, display: "block" }}>Class select karo *</label>
                <div style={{ display: "flex", gap: 10 }}>
                  {CLASSES.map(cls => (
            ...
            {form.courseId && (
              <div style={{ marginBottom: 20, padding: 16, background: "var(--bg)", borderRadius: 10, border: "1px solid var(--border)" }}>
                ...
                <div className="form-group" style={{ marginBottom: 0 }}>
                  <label className="label">Fee amount (₹) — Admin change kar sakta hai *</label>
                  <input
                    className="input"
                    type="number"
                    value={form.fee}
                    onChange={e => setForm({ ...form, fee: e.target.value })}
                    placeholder="Fee enter karo"
                    style={{ fontWeight: 700, fontSize: 16 }}
                  />
                  {selectedCourse?.total_fee && Number(form.fee) !== selectedCourse.total_fee && (
                    <div style={{ fontSize: 12, color: "var(--warning)", marginTop: 4 }}>
                      Default: ₹{selectedCourse.total_fee.toLocaleString()} — aapne change kiya
                    </div>
                  )}
                </div>
              </div>
            ...
            {subjects.length > 0 && (
              <div style={{ marginBottom: 20 }}>
                <label className="label" style={{ marginBottom: 10, display: "block" }}>
                  Subjects ({form.selectedSubjects.length} selected) — click karke remove/add karo
                </label>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {subjects.map(sub => {
                    const isSelected = form.selectedSubjects.includes(sub.id);
                    return (
                      <div key={sub.id} onClick={() => toggleSubject(sub.id)} style={{
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
              ...
              <button className="btn" onClick={() => {
                if (!form.courseId) { setMsg({ type: "error", text: "Stream aur class select karo!" }); return; }
                if (!form.fee || Number(form.fee) <= 0) { setMsg({ type: "error", text: "Fee amount enter karo!" }); return; }
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
              ...
              <button className="btn btn-success" style={{ flex: 1, padding: 14, fontSize: 15 }} onClick={submit} disabled={loading}>
                {loading ? "Admission ho raha hai..." : "✓ Complete Admission"}
              </button>
            </div>
          </div>
        )}
...
function GuardiansTab() {
  ...
  const addGuardian = async () => {
    ...
    try {
      ...
      setMsg(`Guardian added! Pass: ${tempPass}`); setForm({ fullName: "", email: "", phone: "", relation: "", occupation: "" }); setShowForm(false); loadGuardians(selStudent);
  ...
  return (
    <div><h1 className="page-title">Guardian management</h1><p className="page-sub">Link parents/guardians to students</p>
      <div style={{ display: "flex", gap: 20 }}>
        ...
        <div style={{ flex: 1 }}>{!selStudent ? <div className="card empty-state">Select a student</div> : (<div>
          ...
          {guardians.length === 0 ? <div className="card empty-state">No guardians linked.</div> : guardians.map(sg => (<div key={sg.id} className="card" style={{ marginBottom: 12 }}><div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><span style={{ fontWeight: 700, fontSize: 15 }}>{sg.guardians?.profiles?.full_name}</span>{sg.is_primary && <span className="badge badge-success">Primary</span>}{sg.guardians?.relation && <span className="badge badge-primary">{sg.guardians.relation}</span>}</div><div style={{ fontSize: 13, color: "var(--muted)", marginTop: 4 }}>{sg.guardians?.profiles?.phone || ""} | {sg.guardians?.profiles?.email || ""}</div></div><div style={{ display: "flex", gap: 6 }}>{!sg.is_primary && <button className="btn-outline" style={{ fontSize: 12, padding: "6px 12px" }} onClick={() => setPrimary(sg.id)}>Set primary</button>}<button style={{ background: "none", border: "none", color: "var(--danger)", cursor: "pointer", fontSize: 12, fontWeight: 600 }} onClick={() => removeLink(sg.id)}>Remove</button></div></div></div>))}
        </div>)}</div>
      </div>
    </div>
  );
  ...
  return (
    <div>
      <div className="sidebar">
        <div className="sidebar-header"><h1 style={{ fontSize: 17, fontWeight: 700, letterSpacing: "-0.3px" }}>My Career Academic</h1><div style={{ fontSize: 11, opacity: 0.6, marginTop: 4 }}>Coaching Management</div></div>
